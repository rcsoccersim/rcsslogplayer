...
namespace rcss
{
    ...
    private:
        ...
        void
        handleDispInfo( std::streampos pos,
                        const dispinfo_t& info )
        { doHandleDispInfo( pos, info ); }
        
        void
        handleShowInfo( std::streampos pos,
    ...
    protected:
        virtual
        void
        doHandleLogVersion( int ver ) = 0;

        virtual
        int
        doGetLogVersion() const = 0;
