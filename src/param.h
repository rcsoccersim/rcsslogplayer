...
#define BALL_DECAY		0.8
#define BALL_RAND		0.2
#define BALL_WEIGHT		0.2
#define BALL_T_VEL		0.001
#define BALL_SPEED_MAX	32.0
// th 6.3.00
#define BALL_ACCEL_MAX	1.6
//
...
#define PLAYER_DECAY		0.5
#define PLAYER_RAND			0.1
#define PLAYER_WEIGHT		60.0
#define PLAYER_SPEED_MAX	32.0
// th 6.3.00
#define PLAYER_ACCEL_MAX	0.6
//
#define	STAMINA_MAX			2500.0
#define	STAMINA_INC_MAX		50.0
#define RECOVERY_DEC_THR	0.3
#define RECOVERY_DEC		0.05
#define RECOVERY_MIN		0.1
#define EFFORT_DEC_THR		0.4
#define EFFORT_DEC			0.05
#define EFFORT_MIN			0.1
#define EFFORT_INC_THR		0.9
#define EFFORT_INC			0.05
#define HEAR_MAX 2
#define HEAR_INC 1
#define HEAR_DECAY 1
